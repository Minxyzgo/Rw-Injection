...
public strictfp class GameOutputStream {
    ...
    public GameOutputStream(int p0) {
        super();
    }
    ...
    public GameOutputStream(DataOutputStream p0) {
        super();
    }
    ...
    public void a(ByteArrayOutputStream p0) {
    }
